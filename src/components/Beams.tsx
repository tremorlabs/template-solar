import { RiPlaneLine, RiSignalTowerFill } from "@remixicon/react"
import { motion } from "framer-motion"

export const PulseBeamsSecond = () => {
  return (
    <div className="mx-auto flex w-full max-w-6xl rounded bg-gray-950">
      <div className="mx-auto pb-8 pt-20">
        <div className="relative">
          <div className="absolute -top-4 left-32">
            <div className="relative flex items-center justify-center">
              <RiPlaneLine className="z-20 size-5 rotate-90 text-white" />
              <div className="absolute z-10 size-10 rounded-full bg-black/50 shadow-lg ring-1 ring-white/10"></div>
              <div className="absolute top-0 h-96 items-center justify-center">
                <div
                  className="blur-x h-0 w-0 opacity-15 blur-lg"
                  style={{
                    borderLeft: "50px solid transparent",
                    borderRight: "50px solid transparent",
                    borderBottom: "180px solid #fb923c",
                  }}
                ></div>
              </div>
              <div
          ...
          <div className="absolute right-56 top-9">
            <div className="relative flex items-center justify-center">
              ...
              <div className="absolute size-10 rounded-full bg-black/50 shadow-lg ring-1 ring-white/10 backdrop-blur-sm"></div>
            </div>
          </div>
          <div className="absolute -top-9 right-56">
            <div className="relative flex items-center justify-center">
              <RiPlaneLine className="z-10 size-5 text-white" />
              <div className="absolute size-10 rounded-full bg-black/50 shadow-lg ring-1 ring-white/10 backdrop-blur-sm"></div>
            </div>
          </div>
