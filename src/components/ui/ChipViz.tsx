  ...
  return (
    <div className="relative flex items-center">
      <div className="relative">
        <motion.div
          variants={createVariants({ scale: 1.15, delay: 0 })}
          initial="initial"
          animate="animate"
        ...
        />
        <motion.div
          variants={createVariants({ scale: 1.12, delay: 0.1 })}
          initial="initial"
          animate="animate"
        ...
        >
          <motion.div
            variants={createVariants({ scale: 1.1, delay: 0.2 })}
            initial="initial"
            animate="animate"
          ...
          >
            <div className="relative flex h-full w-full items-center justify-center overflow-hidden rounded-full bg-black/40 shadow-sm shadow-white/40 will-change-transform">
              ...
              <motion.div
                variants={createVariants({ scale: 1.08, delay: 0.3 })}
                initial="initial"
                animate="animate"
              ...
              />
              <motion.div
                variants={createVariants({ scale: 1.05, delay: 0.4 })}
                initial="initial"
                animate="animate"
